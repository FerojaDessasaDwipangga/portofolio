      ...
      <div className="container relative z-10 mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-base-content/60 max-w-xl leading-relaxed font-medium">
            PPC Field Apprentice yang menjembatani operasional manufaktur dan teknologi digital.
            Merancang sistem pelacakan Work-In-Progress (WIP) berbasis web yang sukses
            mengubah pencatatan kertas manual menjadi data real-time dan mempercepat pembuatan
            laporan alur kerja pabrik.
          </p>
